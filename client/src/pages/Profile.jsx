...
const Profile = () => {
  ...
  useEffect(() => {
    const getMyDetails = async () => {
      let details = await fetch(GET_MY_DETAILS, {
        method: "GET",
        credentials: "include",
      });
          ...
          <div className="w-full min-h-screen px-3 py-2">
            <div className="w-full h-fit border border-gray-300 rounded-md flex justify-between">
              <div className="flex px-4">
                <div className="p-[4px] w-fit h-fit border border-gray-400 rounded-full m-2 relative ">
                  <img
                    src={
                      myDetails.user_photo
                        ? myDetails.user_photo
                        : DEFAULT_USER_IMG
                    }
              ...
              <div className="px-5 py-5">
                <div
                  ...
                  className="flex w-fit h-fit py-2 px-3 hover:bg-gray-200/90 cursor-pointer border border-[#313131] items-center rounded-md relative"
                >
                  <div className="px-2">
                    <EditLogoIcon />
                  </div>
